...
data_EGR_neutral = read_csv("normSFS_EGR_neutral.csv",col_names = F)
...
data_10GR_neutral = read_csv("normSFS_10GR_neutral.csv",col_names = F)
...
data_100GR_neutral = read_csv("normSFS_100GR_neutral.csv",col_names = F)
...
norm_SFS_data = bind_rows(EGR_neutral,r10GR_neutral,r100GR_neutral) %>%
  as_tibble()
norm_SFS_data

rm(EGR_neutral,r10GR_neutral,r100GR_neutral)

norm_SFS_data$submodel <- factor(norm_SFS_data$submodel , levels=c("EGR", "10GR","100GR"))
