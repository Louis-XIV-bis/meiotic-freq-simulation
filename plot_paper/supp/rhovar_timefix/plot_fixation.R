...
# p-value = 0.2012 ==> No significiant != between some groups 

kruskal.test(time -2000 ~ factor(m), data = t_mid)
# p-value = 0.7989 ==> No significiant != between some groups 

kruskal.test(time -2000 ~ factor(m), data = t_high)
# p-value = 0.1473 ==> No significiant != between some groups 
