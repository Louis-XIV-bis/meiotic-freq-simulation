...
data_EGR_h0p4 = read_csv("rawSFS_EGR_h0p4.csv",col_names = F)
...
data_100GR_h0p4 = read_csv("rawSFS_100GR_h0p4.csv",col_names = F)
...
raw_SFS_data = bind_rows(EGR_h0p4,r100GR_h0p4) %>%
  as_tibble()
raw_SFS_data
