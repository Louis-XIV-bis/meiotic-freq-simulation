...
data_EGR_h0p5 = read_csv("normSFS_EGR_h0p5.csv",col_names = F)
...
data_100GR_h0p5 = read_csv("normSFS_100GR_h0p5.csv",col_names = F)
...
norm_SFS_data = bind_rows(EGR_h0p5,r100GR_h0p5) %>%
  as_tibble()
norm_SFS_data
