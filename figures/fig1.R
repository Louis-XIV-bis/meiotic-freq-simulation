...
data = read_csv('../data/pi_merged.csv') %>%
...
combined_plot <- plot_grid(pi_neutral, pi_ctrl + theme(plot.margin = margin(l = 23)),
                           labels = "AUTO",
                           label_size = 20,
                           ncol = 2,
...
ggsave("fig1.png", plot = combined_plot, width = 16, height = 6, units = "in")
