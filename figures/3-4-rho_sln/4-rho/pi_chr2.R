...
combined_plot <- plot_grid(
  plot_low_chr2 + theme(plot.margin = margin(l = 23)),
  plot_ctrl_chr2 + theme(legend.position = "none", plot.margin = margin(l = 23)),
  plot_high_chr2 + theme(plot.margin = margin(l = 23)), 
...
combined_plot
png('rhovar_chr2.png',width=16,height=8,units="in",bg = "white", res=600)
combined_plot
dev.off()
